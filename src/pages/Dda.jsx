...
const contentData = [{"dda_id":"1","title":"Dhono Dhanyo Auditorium","hall_type":"Main Auditorium","hall_num":"2nd\/ 3rd\/ 4th floor","seating_capacity":"2,000","rent":"200000","deposit":"100000","additional_hour_at":"17000","image": BbccHall1},
{"dda_id":"2","title":"Dhono Dhanyo Auditorium","hall_type":"Mini Auditorium","hall_num":"1st\/ 2nd floor","seating_capacity":"540","rent":"90000","deposit":"50000","additional_hour_at":"7500"},
{"dda_id":"3","title":"Dhono Dhanyo Auditorium","hall_type":"Street Theatre","hall_num":"Ground floor","seating_capacity":"400","rent":"50000","deposit":"25000","additional_hour_at":"4000"},
{"dda_id":"4","title":"Dhono Dhanyo Auditorium","hall_type":"Banquet Hall 3","hall_num":"Ground floor","seating_capacity":"250","rent":"50000","deposit":"25000","additional_hour_at":"4000"},
{"dda_id":"5","title":"Dhono Dhanyo Auditorium","hall_type":"Banquet Hall 4","hall_num":"1st floor","seating_capacity":"250","rent":"60000","deposit":"25000","additional_hour_at":"5000"},
{"dda_id":"6","title":"Dhono Dhanyo Auditorium","hall_type":"Banquet Hall 5","hall_num":"2nd floor","seating_capacity":"250","rent":"60000","deposit":"25000","additional_hour_at":"5000"},
{"dda_id":"7","title":"Dhono Dhanyo Auditorium","hall_type":"Board Room Hall 6, 7, 8","hall_num":"1st floor","seating_capacity":"50","rent":"20000","deposit":"25000","additional_hour_at":"1500"},
{"dda_id":"8","title":"Dhono Dhanyo Auditorium","hall_type":"Lounge Hall 9 & 10","hall_num":"2nd floor","seating_capacity":"150","rent":"25000","deposit":"25000","additional_hour_at":"2000"}];

const generateHallInfo = (item) => {
    return `DDA ${item.hall_type} (${item.hall_num})`;
};
...
function Dda() {
    ...
    const handleCheckAvailability = () => {
        const formattedStartDate = dayjs(checkInDate).format('YYYY-MM-DD');
        const formattedEndDate = dayjs(checkOutDate).format('YYYY-MM-DD');
        const propertyFullInfoName = `Dda ${selectedProperty} (${selectedHallNo})`;
    ...
    const propertyFullName = `Dda ${selectedProperty} (${selectedHallNo})`;
                        ...
                        {availabilityMessage.includes("not available") ? (
                            ...
                            availabilityMessage.includes("available") && (
                                <div className='py-3 px-5' style={{ maxHeight: '80vh', overflowY: 'auto' }}>
                                    <Typography className='text-center text-base font-semibold text-green-600'>Dda {selectedProperty} ({selectedHallNo}) is available for selected date.</Typography>
                                    ...
                                    <div className='bg-green-50 p-3 mb-5'>
                                        <Typography>Property: Dda {selectedProperty} ({selectedHallNo})</Typography>
