...
export default function DateTimePickerCheckout({ propertySelected, onEndDateChange }) {
  ...
  // Fetch unavailable dates from the local API
  useEffect(() => {
    if (propertySelected) {
  ...
  // Function to add a class for unavailable dates
  ...
  return (
    <div className="custom-calendar-container">
      <input
        ...
        readOnly
        placeholder="Pick Checkout Date"
